      ...
      <nav className="sz-navbar d-flex align-items-center px-3 px-md-4 gap-3">
        ...
        <div className="d-flex align-items-center gap-2 me-3"
          ...
          <svg width="46" height="46" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Main square */}
            <rect width="46" height="46" rx="14" fill="url(#mbg)" />
            {/* Frosted top band */}
            ...
            {/* Z shadow */}
            <path d="M14 18 L36 18 L14 34 L36 34"
              stroke="rgba(0,0,0,0.2)" strokeWidth="5.5" strokeLinecap="round" strokeLinejoin="round" fill="none" transform="translate(1.5,1.5)" />
            {/* Z main */}
            <path d="M13 16 L35 16 L13 32 L35 32"
