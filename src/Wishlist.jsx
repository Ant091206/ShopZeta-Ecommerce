...
function Wishlist({ userSession }) {
    ...
    const fetchWishlist = async (s) => {
        try {
            ...
            const r = await axios.post("http://akashsir.in/atproject/at-shop/api/api-list-wishlist.php", fd, { headers: { Authorization: `Bearer ${token}` } });
    ...
    const handleRemove = async (e, wishlistId) => {
        ...
        try {
            const r = await axios.post("http://akashsir.in/atproject/at-shop/api/api-delete-wishlist.php", fd, { headers: { Authorization: `Bearer ${token}` } });
